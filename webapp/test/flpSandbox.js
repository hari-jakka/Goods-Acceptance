		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#euaidengagoodsacceptance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"euaidengagoodsacceptance-display": {
								"semanticObject": "euaidengagoodsacceptance",
								"action": "display",
								"description": "Goods Acceptance application",
								"title": "Goods Acceptance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=eu.aiden.ga.goodsacceptance",
									"url": sap.ui.require.toUrl("eu/aiden/ga/goodsacceptance")
								}
							}
						}
					}
