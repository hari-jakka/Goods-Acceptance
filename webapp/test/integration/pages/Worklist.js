					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("EquipmentID"),
								name: oBindingContext.getProperty("SerialNumber")
							};
						}
					}));
				},
						...
						success : function (oTable) {
							...
							this.waitFor({
								...
								matchers : function (oPage) {
									var sExpectedText = oPage.getModel("i18n").getResourceBundle().getText("lblDeliveriesCount", [iObjectCount]);
