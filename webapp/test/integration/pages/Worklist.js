      ...
      onTheWorklistPage: {
        ...
        actions: Object.assign({
              ...
              createWaitForItemAtPosition({
                ...
                success: function (oTableItem) {
                  ...
                  this.getContext().currentItem = {
                    ...
                    id: oBindingContext.getProperty("DeliveryDocument"),
                    name: oBindingContext.getProperty("MaterialNumber"),
                  };
                },
              }),
            );
          ...
          iTypeSomethingInTheSearchThatCannotBeFoundAndTriggerRefresh:
            function () {
              var fnEnterTextAndFireRefreshButtonPressedOnSearchField =
                function (oSearchField) {
              ...
              return this.iSearchForValueWithActions(
                fnEnterTextAndFireRefreshButtonPressedOnSearchField,
              );
            },
                ...
                this.waitFor({
                  ...
                  matchers: function (oPage) {
                    var sExpectedText = oPage
                      .getModel("i18n")
                      .getResourceBundle()
                      .getText("lblDeliveriesCount", [iObjectCount]);
